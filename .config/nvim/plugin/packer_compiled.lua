...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/LuaSnip",
    url = "https://github.com/L3MON4D3/LuaSnip"
  },
  ["clipboard-image.nvim"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/clipboard-image.nvim",
    url = "https://github.com/ekickx/clipboard-image.nvim"
  },
  ["cmp-buffer"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/mario/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
